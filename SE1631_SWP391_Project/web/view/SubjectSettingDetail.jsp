                    ...
                    <form action="SubjectSettingDetails" method="POST">
                        <c:if test="${requestScope.mess eq null}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input style="width: 450px;" value="" name="value" type="text" class="form-control" id="inputPassword3" >
                                </div>
                            </div>
                            <fieldset class="form-group">
                                <div class="row">
                                    <legend class="col-form-label col-sm-2 pt-0">Setting Title</legend>
                                    <div class="col-sm-10">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="title" id="gridRadios1" value="Quality" checked>
                                            <label class="form-check-label" for="gridRadios1">
                                                Quality
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="title" id="gridRadios2" value="Complexity">
                            ...
                            <c:if test="${requestScope.mess ne null}">
                                <div class="alert alert-success" role="alert">
                                    ${mess} <a href="/SE1631_SWP391_Project/SubjectSettingList" class="alert-link">Return to Subject List screen</a>.
                                </div>
                            </c:if>
                            ...
                            <c:if test="${requestScope.mess eq null}">
                                <div style="display: flex;">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-10">
                                            <button style="background-color: gray" onclick="location.href = '/SE1631_SWP391_Project/SubjectSettingList'" type="button" class="btn btn-primary">Cancel</button>
                                        </div>
                                    </div>
                                </div>
                            </c:if>
