        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <!--Form search-->
                    <form action = "SubjectSettingList" method="POST">
                        <div class="advanced-search">
                            <div class = "advanced-search-item secondd" id="search-1">
                                <label for="type" class="mr-sm-2">Filter by Title</label>
                            ...
                            <div class = "advanced-search-item secondd" id="search-3">
                                ...
                                <input style="width: 450px" type="text" class="form-control" name ="txt"  id="title" placeholder="Enter Subject code" >
                            </div>
                                        ...
                                        <c:forEach items="${slist}" var="s">
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    <button type="button" onclick="location.href = '/SE1631_SWP391_Project/SubjectSettingList/SubjectSettingDetails?ssid=${s.getSettingId()}';" class="csw-btn-button" >Edit</button>
                                                </td>     
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                ...
                                <div class = "setting-pagination">
                                    <ul class="pagination" id = "paggerBottom">
                                        <c:forEach begin="1" end="${endP}" var="i">
                                            <a class="page-link" href="SubjectSettingList?index=${i}">${i}</a>
                                        </c:forEach>
                                    </ul>
                                </div>
                            </div>
